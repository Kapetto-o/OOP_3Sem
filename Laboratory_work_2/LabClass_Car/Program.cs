...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("Машины Toyota:");
        Car.ShowCarsByBrand(cars, "Toyota");
        Console.WriteLine("Машины модели Accord, которым больше 10 лет:");
        Car.ShowCarsByModelAndAge(cars, "Accord", 10);
        Car.ShowClassInfo();
    }
}