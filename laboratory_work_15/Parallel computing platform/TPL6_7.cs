...
namespace OOP_Lab15
{
    static partial class TPL
    {
        ...
        public static void Task7()
        {
            ...
            Task client1 = new Task(() =>
            {
                Product prod = new Product();
                while (true)
                {
                    if (products.TryTake(out prod) && prod != null)
                    {
                        Console.WriteLine("Клиент 1 забрал продукт");
                    }
                }
            });
            Task client2 = new Task(() =>
            {
                Product prod = new Product();
                while (true)
                {
